...
Enter your API key when prompted. Find it in your [Bugster dashboard](https://dashboard.bugster.dev) under Account Settings.
...
This creates a `.bugster` directory and prompts you for your application's base URL (e.g., `http://localhost:3000`).
